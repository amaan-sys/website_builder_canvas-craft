  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        builder: {
          toolbar: "hsl(var(--builder-toolbar))",
          panel: "hsl(var(--builder-panel))",
          hover: "hsl(var(--builder-hover))",
          selected: "hsl(var(--builder-selected))",
          "drag-overlay": "hsl(var(--builder-drag-overlay))",
        },
        section: {
          hero: "hsl(var(--section-hero))",
          features: "hsl(var(--section-features))",
          services: "hsl(var(--section-services))",
